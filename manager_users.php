                ...
                <tbody>
                    <?php foreach ($result as $pro) : ?>
                        <tr>
                            ...
                            <!--button xóa users (admin)-->
                            <td class="button_fdd">
                                <button class="button_delete"><a onclick ="return confirm('Bạn chắc chắn muốn xóa?');" href="remove_users.php?id=<?php echo $pro['id'] ?>">Xóa</a></button>
                            </td>
